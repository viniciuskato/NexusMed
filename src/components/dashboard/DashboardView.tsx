...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  const srsStats = useMemo(() => {
    ...
    const reviewedToday = stats.cardsReviewedToday;
    const errorLinked = flashcards.filter(
      (fc) => Boolean(fc.questionOriginId) || fc.id.startsWith('err-') || fc.tags?.includes('erro')
    ).length;
  ...
  }, [flashcards, dueCards, stats.cardsReviewedToday]);
