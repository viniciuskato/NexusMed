...
| Missão AS1-A — Inventário editorial e mapa taxonômico da AS1 (Saúde do Adulto 1, prova 21/09) | P1 | **concluído, não publicado** | Nenhuma | Nenhum — só documentação, branch candidata `docs/as1-a-inventario` local | Diretoria decide, a partir de `docs/diretoria/AS1-INVENTARIO-2026-09-17.md` e `docs/diretoria/AS1-TAXONOMIA-PILOTO-2026-09-17.md`: (1) ordem de produção (ondas 0-4 propostas); (2) se corrige taxonomia de disciplina no banco antes de produzir; (3) qual material vence em cada duplicata provável identificada |
| Onda 0 proposta (AS1) — Reconciliação: ler por completo ~12 arquivos do acervo marcados "localizado, não auditado" e decidir 4 duplicatas prováveis (Avaliação da Função Renal, Semiologia Cardíaca, Endocardite Infecciosa, Semiologia respiratória) | P1 | pendente — depende de aprovação da diretoria para abrir | Depende da AS1-A | Nenhum — só leitura/decisão editorial | Diretoria aprovar abertura e definir se é sessão diretoria ou executiva |
| Onda 1 proposta (AS1) — Auditoria científica (Gates 7-8) + conversão para HTML dos temas 3 (Distúrbio Acidobásico), 12 (Dispneia) e 19 (Endocardite Infecciosa), já com conteúdo pronto e de boa qualidade fora do banco | P1 | pendente — depende da Onda 0 | Depende da Onda 0 | Nenhum até publicação | Diretoria decidir se inicia antes da Onda 0 estar fechada, dado o prazo de prova em 21/09 |
