...
| Missão AS1-B3 — Auditoria independente do material convertido (Distúrbio Acidobásico) | P1 | **concluído, não publicado — APROVADO COM CORREÇÕES OBRIGATÓRIAS** — branch local `work/as1-b3-auditoria-conversao-acidobasico`, worktree `.claude/worktrees/as1-b3-auditoria`, a partir de `work/as1-b2-conversao-acidobasico`@`4285231` | Depende da AS1-B2 (concluída) | Nenhum — só documentação (`docs/editorial/as1/ACIDOBASE-AUDITORIA-DA-CONVERSAO-2026-09-18.md`, `docs/diretoria/prompts/AS1-B3.txt`), YAML não alterado, PDF original não tocado, Supabase local consultado só em leitura (disciplina "Nefrologia" e tema "Distúrbio Acidobásico" confirmados **ausentes** no catálogo local), Supabase remoto/produção/main não tocados | Diretoria decide, a partir de `docs/editorial/as1/ACIDOBASE-AUDITORIA-DA-CONVERSAO-2026-09-18.md`: (1) autorizar AS1-B3.1 para corrigir a editora do Johnson (2016) e confirmar o número de diferença ajustada do desfecho primário do SODa-BIC contra o texto integral do NEJM; (2) decidir se cria a disciplina/tema no catálogo ou reatribui o material a nomes existentes; (3) só depois disso, e com ferramenta de navegador real disponível, completar a pré-visualização visual do modal "Importar material" antes de qualquer importação como rascunho |
