> **ARQUIVO MORTO — não representa o estado atual do projeto.**
> Congelado em 2026-09-17 pela Entrega 40-A (continuidade operacional),
> como cópia integral e verbatim do `AGENTS.md` de então, antes de ele
> ser reduzido a um índice curto. Preservado por completo — nada foi
> removido, resumido ou reescrito — só para não perder o histórico de
> armadilhas e o diário de "Estado atual" acumulado até aquela data.
>
> - **Não leia isto para saber o estado atual.** Veja
>   [`docs/operacao/PROJECT_STATE.md`](../operacao/PROJECT_STATE.md).
> - Para decisões vigentes: [`docs/operacao/DECISIONS.md`](../operacao/DECISIONS.md).
> - Para a fila de trabalho: [`docs/operacao/TASKS.md`](../operacao/TASKS.md).
> - O `AGENTS.md` vigente na raiz do repositório é um índice curto que
>   aponta para esses documentos; ele preserva só os riscos/armadilhas
>   de maior probabilidade de recorrência, em versão condensada. Este
>   arquivo é a versão completa, para consulta de detalhe histórico.
> - Datas e hashes citados abaixo são históricos (até 2026-09-17) — não
>   reconfirmados por esta entrega. Sempre reconfira estado técnico atual
>   em `docs/operacao/PROJECT_STATE.md` ou diretamente no repositório.

---

# AGENTS.md — contexto operacional para agentes de IA (histórico, congelado em 2026-09-17)
