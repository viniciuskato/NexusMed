> **Arquivo morto (desde 2026-09-23).** Este é o `PROJECT_STATE.md` como
> estava até 2026-09-23, preservado sem cortes: o diário de cada entrega, de
> 17/09 a 23/09. Não é o estado atual — o estado atual, curto, está em
> [`docs/operacao/PROJECT_STATE.md`](../operacao/PROJECT_STATE.md). Os
> hashes e caminhos daqui são baseline histórica.
